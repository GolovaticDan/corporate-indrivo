...
namespace Drupal\ci_social_media\Form;
 ...
 *
 * @package Drupal\ci_social_media\Form
 *
...
class ConfigurationForm extends ConfigFormBase {
   ...
   * Configuration name.
   */
  const CONFIGURATION_NAME = 'ci_social_media.settings';
  ...
  public function getFormId() {
    return 'ci_social_media_settings_form';
  }
